...
| E12.2 | `docs/ARCHITECTURE.md` with diagrams | M | W13 | todo |
| E12.3 | `docs/EVAL.md`, `docs/SECURITY.md`, `docs/FAILURES.md`, `docs/RUNBOOK.md` | M | W13 | todo |
| E12.4 | ADRs in `docs/adr/` | M | ongoing | todo |
...
### 18.2 docs/
`ARCHITECTURE.md` · `EVAL.md` · `SECURITY.md` · `FAILURES.md` · `RUNBOOK.md` · `PROJECT.md` (this) · `LATER.md` · `adr/ADR-00x-*.md`

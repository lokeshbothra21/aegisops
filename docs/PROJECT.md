...
|---|---|---|---|---|
| E1.1 | OTLP/HTTP receiver (`/ingest/v1/{traces,logs,metrics}`) with protobuf-JSON parsing | M | W1 | done (PR #3) |
...
| E9.7 | CodeQL, dependency review, secret scanning enabled | M | W1 | todo |
...
| E11.6 | Dependabot / Renovate | S | W1 | todo |
